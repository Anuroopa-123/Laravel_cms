  ...
  submitForm(form: any) {
    if (form.valid) {
      const registrationData = {
        ...
        address_line_one: this.formData.addressLine1,
        address_line_two: this.formData.addressLine2,
        city: this.formData.city,
        state: this.formData.state,
        zip_code: this.formData.zip,
        college_organization: this.formData.collegeName,
        department_domain: this.formData.department,
        year_experience: this.formData.year,
