...
export class EmailService {
  ...
  private internshipApplyPath = '/api/internships';
  private contactPath = '/api/contact-us';
  private newslettersPath = '/api/news/';
  private sliderpath = '/api/sliders/';
  private entrepreneurshipPath = '/api/entrepreneurships/';
  private workshopimgPath = '/api/workshops/';
  private feedbackPath = '/api/feedback';
  private registerPath = '/api/course-registrations/';
  private mediaPath = '/api/media-categories/';
  private printmediaPath = '/api/media-items/';
  private careersPath = '/api/jobs/';
  private jobApplicationPath = '/api/job-applications/';
